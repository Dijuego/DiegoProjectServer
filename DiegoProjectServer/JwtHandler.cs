...
namespace DiegoProjectServer
{
    public class JwtHandler(IConfiguration configuration, UserManager<NbaUser> userManager)
    {
        public async Task<JwtSecurityToken> GetTokenAsync(NbaUser user) =>
            new(
        ...
        private async Task<List<Claim>> GetClaimsAsync(NbaUser user)
        {
